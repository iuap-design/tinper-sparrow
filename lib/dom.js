...
var makModalAssign = function makModalAssign(element, parEle) {
	var overlayDiv = document.createElement('div');
...
export { addClass, removeClass, hasClass, toggleClass, closest, css, wrap, getStyle, getZIndex, makeDOM, makeModal, makModalAssign, getOffset, getScroll, showPanelByEle, getElementLeft, getElementTop };